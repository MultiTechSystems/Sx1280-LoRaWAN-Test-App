...
#define MBED_CONF_LORA_APPLICATION_EUI                                        { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x12, 0x34 }                                                 // set by application[*]
#define MBED_CONF_LORA_APPLICATION_KEY                                        { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x12, 0x34 } // set by application[*]
...
#define MBED_CONF_LORA_DEVICE_EUI                                             { 0x00, 0x80, 0x00, 0x00, 0xA0, 0x00, 0x37, 0x09 }                                                 // set by application[*]
...
#define MBED_CONF_SX126X_LORA_DRIVER_ANT_SWITCH                               NC                                                                                                 // set by application[MAX32670_LORA]
...
#define MBED_CONF_SX126X_LORA_DRIVER_BUSY                                     P0_21                                                                                              // set by application[MAX32670_LORA]
#define MBED_CONF_SX126X_LORA_DRIVER_CRYSTAL_SELECT                           NC                                                                                                 // set by application[MAX32670_LORA]
#define MBED_CONF_SX126X_LORA_DRIVER_DEVICE_SELECT                            NC                                                                                                 // set by application[MAX32670_LORA]
#define MBED_CONF_SX126X_LORA_DRIVER_DEVICE_VARIANT                           SX1262                                                                                             // set by application[MAX32670_LORA]
#define MBED_CONF_SX126X_LORA_DRIVER_DIO1                                     P0_22                                                                                              // set by application[MAX32670_LORA]
#define MBED_CONF_SX126X_LORA_DRIVER_FREQ_SELECT                              NC                                                                                                 // set by application[MAX32670_LORA]
#define MBED_CONF_SX126X_LORA_DRIVER_FREQ_SUPPORT                             0                                                                                                  // set by application[MAX32670_LORA]
#define MBED_CONF_SX126X_LORA_DRIVER_REGULATOR_MODE                           1                                                                                                  // set by library:SX126X-lora-driver
#define MBED_CONF_SX126X_LORA_DRIVER_RESET                                    P0_20                                                                                              // set by application[MAX32670_LORA]
#define MBED_CONF_SX126X_LORA_DRIVER_SLEEP_MODE                               1                                                                                                  // set by library:SX126X-lora-driver
#define MBED_CONF_SX126X_LORA_DRIVER_SPI_CS                                   SPI1_SS                                                                                            // set by application[MAX32670_LORA]
#define MBED_CONF_SX126X_LORA_DRIVER_SPI_FREQUENCY                            16000000                                                                                           // set by library:SX126X-lora-driver
#define MBED_CONF_SX126X_LORA_DRIVER_SPI_MISO                                 SPI1_MISO                                                                                          // set by application[MAX32670_LORA]
#define MBED_CONF_SX126X_LORA_DRIVER_SPI_MOSI                                 SPI1_MOSI                                                                                          // set by application[MAX32670_LORA]
#define MBED_CONF_SX126X_LORA_DRIVER_SPI_SCLK                                 SPI1_SCK                                                                                           // set by application[MAX32670_LORA]
#define MBED_CONF_SX126X_LORA_DRIVER_STANDBY_MODE                             0                                                                                                  // set by library:SX126X-lora-driver
#define MBED_CONF_SX126X_LORA_DRIVER_XTAL                                     -1                                                                                                 // set by application[MAX32670_LORA]
